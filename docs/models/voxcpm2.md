...
This page tracks VoxCPM2 nightly TTS performance by test configuration, including latency, audio timing, and throughput metrics.
</p>

<section
  class="omni-history-page"
  data-omni-history-src="../../assets/charts/voxcpm2_history.json"
  markdown="1"
>
