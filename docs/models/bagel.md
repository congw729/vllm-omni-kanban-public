...
This page tracks BAGEL nightly benchmark runs across text-to-image and image-to-image workloads, including single-stage and multi-stage configurations.
</p>

<section
  class="omni-history-page"
  data-omni-history-src="../../assets/charts/bagel_history.json"
  markdown="1"
>
