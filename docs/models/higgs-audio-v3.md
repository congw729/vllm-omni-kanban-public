...
This page tracks Higgs Audio V3 nightly TTS performance by test configuration, including audio throughput, latency, RTF, and TTFP metrics.
</p>

<section
  class="omni-history-page"
  data-omni-history-src="../../assets/charts/higgs_audio_v3_history.json"
  markdown="1"
>
...
<div class="omni-section">
  <div class="omni-section__header">
    <p>Filter by test profile and runtime settings.</p>
  </div>
